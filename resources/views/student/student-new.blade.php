    ...
    <div class=" container">
        <div class="panel">
            <div class="panel-body wizard-content">
                <form id="example-form" action="{{ url('/studentStore') }}" method="post" enctype="multipart/form-data"
                    class="tab-wizard wizard-circle wizard clearfix">
                    @csrf
                    <h5>Basic Information</h5>
                    <section class="container form_1 data_info">
                        <div>
                            <h4 class="p-2 text-white text-center rounded" style="background-color: #0d437cbd;">Basic
                                information</h4>
                            <div class="row g-3 mt-3">
                                ...
                                <div class=" col-md-5">
                                    ...
                                    <div class="form-check-inline">
                                        <input class="form-check-input" type="radio" id="inlineRadio2" value="Other"
                                            name="gender">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="file" id="exampleFormControlFile1" class="form-control-file"
                                        accept="/image/*" onchange="previewImage(event);" name="image">
                    ...
                    <section class="container form_3 data_info py-2">
                        ...
                        <div class="mt-5">
                            <form class="decleration mt-3 mx-5">
                                ...
                                <div class="col-md-5">
                                    <label for="exampleFormControlFile1">Profile picture :</label>
                                    <input type="file" id="exampleFormControlFile1" class="form-control-file"
                                        onchange="previewSign(event);" name="sign">
                                    <img id="previewSn" style="height:150px" ; width="150px" src="">
                                </div>
                        </div>
                        <div class="row mb-3 ms-1">
                            <div class="col-sm-5 form-check">
                                <input class="form-check-input" class="col-sm-2 col-form-label" type="checkbox"
                                    id="gridCheck" name="check" value="1">
                        ...
                        <div>
                            <button type="submit" name="submit"
                                class="btn btn-primary btn_submit_test">Submit</button>
                        </div>
                </form>
            </div>
            </section>
